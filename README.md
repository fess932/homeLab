...
- иначе — типовые нормы из `drivers/thresholds.go`: влажность 30–60 % (ниже 20 и выше 70 — красный), CO₂ 1000/2000 ppm, PM2.5 35/75, PM10 50/100 мкг/м³, формальдегид 0,08/0,1 мг/м³, заряд батареи ниже 20/10 %. Температуры там нет: датчик может стоять и дома, и на улице;
