...
- для PM2.5 и PM10 заданы ещё суточные нормы ВОЗ (15 и 45 мкг/м³). Сервер считает среднее за последние 24 часа, и под значением появляется строка вроде «за сутки 18 мкг/м³ — выше нормы 15».
